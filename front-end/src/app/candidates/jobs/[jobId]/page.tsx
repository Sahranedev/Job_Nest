...
import ModalConfirmApply from "../../../_components/Candidatures/ModalConfirmApply";
...
const JobDetailsPage = () => {
  ...
  const handleSubmit = async (application: {
    ...
    try {
      ...
      toast.success(
        () => <div>Votre candidature a été envoyée avec succès.</div>,
        {
          position: "top-right",
          autoClose: 4000,
          ...
          <div className="w-2/3">
            ...
            <div>
              <p>
                ...
                perspiciatis nesciunt ex id laudantium accusamus illo! Magni
                vero nulla recusandae voluptatem quod eveniet assumenda aliquam!
                Omnis, ea numquam accusamus reiciendis nesciunt sed inventore
                velit, debitis vel harum illum modi id? Exercitationem incidunt
                nisi repellat impedit consectetur, inventore distinctio optio,
                eius, esse enim eos facere laudantium earum numquam. Quaerat
                repellendus officia harum odio laborum id architecto consectetur
                recusandae labore laboriosam dolor reprehenderit illum commodi
                blanditiis fugiat rem magni, perspiciatis et vel nam facilis.
                Facilis distinctio repudiandae explicabo obcaecati ipsa, ducimus
                dignissimos exercitationem ratione vitae quibusdam dolorum
                pariatur deserunt nulla optio rerum et voluptatum similique?
                Sint soluta provident at labore odit quas aspernatur ut ipsum
                obcaecati necessitatibus molestiae officiis velit possimus
                molestias quod tempore similique ipsam, nam repudiandae quos.
                Iure aliquid incidunt consequuntur ab dolores facilis ipsa natus
                harum neque quos itaque deleniti sapiente numquam vero quibusdam
                delectus sint consequatur quia repudiandae voluptates
                reiciendis, error sequi cupiditate. Dolore illo culpa maiores
                ipsa inventore accusamus dignissimos, tenetur earum amet sunt
                officiis sint possimus harum laborum? Commodi molestias deserunt
                perspiciatis soluta, nisi odio sint unde. Incidunt, rerum
                voluptatem inventore, sequi neque impedit reiciendis quam eaque
                vitae doloremque perferendis sit nisi ipsum aspernatur, facilis
                repellat?
              </p>
            </div>
          </div>
